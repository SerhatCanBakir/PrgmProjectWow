       ...
       {  static int i=0;
          ...
          switch(SelectedWord[i+1])
          {
           ...
           {  
               ...
               case 'C' : DrawLineEx(Avec,temp,20,(Color){0,0,0,150});DrawCircleV(temp,20,(Color){0,0,0,150});
               if(temp.x!=Mvec.x&&temp.y!=Mvec.y){i++;CizgiCizLvl3(SelectedWord,Avec,Bvec,Cvec,Dvec,Mvec);}
               break;
               case 'L' : DrawLineEx(Bvec,temp,20,(Color){0,0,0,150});DrawCircleV(temp,20,(Color){0,0,0,150});
               if(temp.x!=Mvec.x&&temp.y!=Mvec.y){i++;CizgiCizLvl3(SelectedWord,Avec,Bvec,Cvec,Dvec,Mvec);}
               break;
               case 'E' : DrawLineEx(Cvec,temp,20,(Color){0,0,0,150});DrawCircleV(temp,20,(Color){0,0,0,150});
               if(temp.x!=Mvec.x&&temp.y!=Mvec.y){i++;CizgiCizLvl3(SelectedWord,Avec,Bvec,Cvec,Dvec,Mvec);}
               break;
               case 'I' : DrawLineEx(Dvec,temp,20,(Color){0,0,0,150});DrawCircleV(temp,20,(Color){0,0,0,150});
               if(temp.x!=Mvec.x&&temp.y!=Mvec.y){i++;CizgiCizLvl3(SelectedWord,Avec,Bvec,Cvec,Dvec,Mvec);}
               break;
          }
          }
